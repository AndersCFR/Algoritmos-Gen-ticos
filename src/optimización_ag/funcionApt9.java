 ...
 * @author Anderson
 */
public class funcionApt9 extends FitnessFunction {
    ...
    private void Evaluar(IChromosome cromosoma) {
        ...
        valorY = (3.5-Math.abs((2*Math.log10(x))-3-(Math.log10(x/10))))-3.5;
        System.out.println(x +" ; "+ valorY );
        fitness = 3.5-((2*Math.log10(x))-3-(Math.log10(x/10)));
        //2 lg(x)=3+lg(x/10)
    }

    public double getY(float x) {
        double v_opt_y=0;
        v_opt_y = (3.5-Math.abs((2*Math.log10(x))-3-(Math.log10(x/10))))-3.5;
        return v_opt_y;
    }
}
