 ...
 * @author Anderson
 */
public class pruebaAG4{
   
    public void empezar() {
        try {
            //Configuramos JGAP
            Configuration configuracion = new DefaultConfiguration();
            FitnessFunction funcion = new funcionApt4();
            ...
            show.mostrarIndividuo_4bits(population.getFittestChromosome()); //mejor individuo obtenido
            funcionApt4 f = new funcionApt4();
            double y = f.getY(show.obtenerValorIndividuo_4bits(population.getFittestChromosome()));
