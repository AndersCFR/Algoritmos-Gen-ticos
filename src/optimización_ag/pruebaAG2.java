     ...
     public void empezar() {
        try {
            ...
            for (int m = 0; m < 5; m++) { //50 iteraciones, cada iteracion sera una generacion
                ...
                show.mostrarIndividuo_3bits(mejor_individuo);
            ...
            show.mostrarIndividuo_3bits(population.getFittestChromosome()); //mejor individuo obtenido
            funcionApt2 f = new funcionApt2();
            double y = f.getY(show.obtenerValorIndividuo_3bits(population.getFittestChromosome()));
