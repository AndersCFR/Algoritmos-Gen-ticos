 ...
 * @author Anderson
 */
public class funcionApt6 extends FitnessFunction{
    ...
    private void Evaluar(IChromosome cromosoma) {
        ...
        valorY = (1.5-Math.abs(3*Math.log10(x)-Math.log10(32)-Math.log10(x/2)))-1.5;
        System.out.println(x +" ; "+ valorY );
        //fitness = 256 - Math.abs(valor - 50);
        fitness = 1.5-(3*Math.log10(x)-Math.log10(32)-Math.log10(x/2));
        //3lg(x)-lg(32)=lg(x/2)
    }

    public double getY(float x) {
        double v_opt_y=0;
        v_opt_y = (1.5-Math.abs(3*Math.log10(x)-Math.log10(32)-Math.log10(x/2)))-1.5;
        return v_opt_y;
    }
