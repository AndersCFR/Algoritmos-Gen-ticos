 ...
 * @author Anderson
 */
public class pruebaAG5 {
    public void empezar() {
        try {
            //Configuramos JGAP
            Configuration configuracion = new DefaultConfiguration();
            FitnessFunction funcion = new funcionApt5();
            ...
            genEjemplo[0] = new IntegerGene(configuracion, 1, 1);
            ...
            genEjemplo[13] = new IntegerGene(configuracion, 0, 1);
            genEjemplo[14] = new IntegerGene(configuracion, 0, 1);
            genEjemplo[15] = new IntegerGene(configuracion, 0, 1);
            genEjemplo[16] = new IntegerGene(configuracion, 0, 1);
            genEjemplo[17] = new IntegerGene(configuracion, 0, 1);
            genEjemplo[18] = new IntegerGene(configuracion, 0, 1);
            genEjemplo[19] = new IntegerGene(configuracion, 0, 1);
            ...
            configuracion.setPopulationSize(6); //Creamos nuestra poblacion inicial
            ...
            for (int m = 0; m < 6; m++) { //50 iteraciones, cada iteracion sera una generacion
                ...
                show.mostrarTodosIndividuos_3bits(population.getChromosomes());
                ...
                show.mostrarIndividuo_decimal(mejor_individuo);
            ...
            show.mostrarIndividuo_decimal(population.getFittestChromosome()); //mejor individuo obtenido
            funcionApt5 f = new funcionApt5();
            double y = f.getY(show.obtenerValorIndividuo_decimal(population.getFittestChromosome()));
