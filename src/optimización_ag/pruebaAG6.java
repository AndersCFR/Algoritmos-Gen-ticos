 ...
 * @author Anderson
 */
public class pruebaAG6 {
        public void empezar() {
        try {
            //Configuramos JGAP
            Configuration configuracion = new DefaultConfiguration();
            FitnessFunction funcion = new funcionApt6();
            ...
            configuracion.setPopulationSize(7); //Creamos nuestra poblacion inicial
            ...
            for (int m = 0; m < 7; m++) { //50 iteraciones, cada iteracion sera una generacion
                System.out.println("-------------------Inicio generacion-------------------");
                System.out.println("Iteracion #" + m);
                show.mostrarTodosIndividuos_4bits(population.getChromosomes());
                ...
                show.mostrarIndividuo_4bits(mejor_individuo);
            ...
            show.mostrarIndividuo_4bits_positivos(population.getFittestChromosome()); //mejor individuo obtenido
            funcionApt6 f = new funcionApt6();
            double y = f.getY(show.obtenerValorIndividuo_4bits_positivos(population.getFittestChromosome()));
