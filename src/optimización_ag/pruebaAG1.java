 ...
 * @author Anderson
 */
public class pruebaAG1 {
    
    public void empezar() {
        try {
            //Configuramos JGAP
            Configuration configuracion = new DefaultConfiguration();
            FitnessFunction funcion = new funcionApt1();
            ...
            configuracion.setPopulationSize(8); //Creamos nuestra poblacion inicial
            ...
            for (int m = 0; m < 8; m++) { //50 iteraciones, cada iteracion sera una generacion
